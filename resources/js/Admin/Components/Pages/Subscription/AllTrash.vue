...
export default {
    ...
    data( ) { return {
        ...
        Columns :  [
                ...
                { type: 'String'    ,header : 'number of months'    , name : 'month_number'          , value : null  } ,
                { type: 'String'    ,header : 'number of children'  , name : 'child_number'          , value : null  } ,                
