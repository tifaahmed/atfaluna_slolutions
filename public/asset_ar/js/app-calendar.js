$(function() {
	...
	var highlightedDays = ['2021-6-4', '2021-6-2', '2018-5-12', '2018-5-13', '2018-5-14', '2018-5-15', '2018-5-16'];
	var date = new Date();
	...
	$('#calendar').fullCalendar({
		...
		eventSources: [azCalendarEvents, azBirthdayEvents, azHolidayEvents, azOtherEvents,endedEvents],
	...
	$('.main-nav-calendar-event a').on('click', function(e) {
		...
		if ($(this).hasClass('exclude')) {
			...
			$(this).is(':nth-child(5)') ? azCalendar.addEventSource(endedEvents) : '';
