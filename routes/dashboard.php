...
Route::group(['middleware' => ['auth:api','role:admin']], fn ( ) : array => [
    ...
    // IntroductionContent
        Route::name('introduction_content.')->prefix('/introduction_content')->group( fn ( ) : array => [
            ...
            Route::get('/{id}/restore'             ,   'IntroductionContentController@restore'             )->name('restore'),
    ...
    // About_us
        Route::name('about_us.')->prefix('/about_us')->group( fn ( ) : array => [
            ...
            Route::get('/{id}/restore'             ,   'AboutUsController@restore'             )->name('restore'),
    ...
    // Contact_us
        Route::name('contact_us.')->prefix('/contact_us')->group( fn ( ) : array => [
            ...
            Route::get('/{id}/restore'             ,   'ContactUsController@restore'             )->name('restore'),
    ...
    // QuestionTag
        ...
        Route::name('avatar.')->prefix('/avatar')->group( fn ( ) : array => [
            ...
            Route::get('/{id}/restore'             ,   'AvatarController@restore'             )->name('restore'),
        ...
        Route::name('skill.')->prefix('/skill')->group( fn ( ) : array => [
            ...
            Route::get('/{id}/restore'             ,   'SkillController@restore'             )->name('restore'),
        ...
        Route::name('skillable.')->prefix('/skillable')->group( fn ( ) : array => [
            ...
            Route::get('/{id}/restore'             ,   'SkillableController@restore'             )->name('restore'),
        ...
        Route::name('age-group.')->prefix('/age-group')->group( fn ( ) : array => [
            ...
            Route::get('/{id}/restore'             ,   'AgeGroupController@restore'             )->name('restore'),
        ...
        // Accessory
            Route::name('accessory.')->prefix('/accessory')->group( fn ( ) : array => [
                ...
                Route::get('/{id}/restore'             ,   'AccessoryController@restore'             )->name('restore'),
        ...
        // Achievement
            Route::name('achievement.')->prefix('/achievement')->group( fn ( ) : array => [
                ...
                Route::get('/{id}/restore'             ,   'AchievementController@restore'             )->name('restore'),
            ...
            Route::name('achievementimage.')->prefix('/achievementimage')->group( fn ( ) : array => [
                ...
                Route::get('/{id}/restore'             ,   'AchievementImageController@restore'             )->name('restore'),
        ...
        // Lesson
            Route::name('lesson.')->prefix('/lesson')->group( fn ( ) : array => [
                ...
                Route::get('/{id}/restore'             ,   'LessonController@restore'             )->name('restore'), 
        ...
        // McqAnswer
            Route::name('mcq-answer.')->prefix('/mcq-answer')->group( fn ( ) : array => [
                ...
                Route::get('/{id}/restore'             ,   'McqAnswerController@restore'             )->name('restore'),
        ...
        //McqQuestion
            Route::name('mcq-question.')->prefix('/mcq-question')->group( fn ( ) : array => [
                ...
                Route::get('/{id}/restore'             ,   'McqQuestionController@restore'             )->name('restore'),
        ...
        // MatchAnswer
            Route::name('match-answer.')->prefix('/match-answer')->group( fn ( ) : array => [
                ...
                Route::get('/{id}/restore'             ,   'MatchAnswerController@restore'             )->name('restore'),
        ...
        //MatchQuestion
            Route::name('match-question.')->prefix('/match-question')->group( fn ( ) : array => [
                ...
                Route::get('/{id}/restore'             ,   'MatchQuestionController@restore'             )->name('restore'),
        ...
        // Activity
            Route::name('activity.')->prefix('/activity')->group( fn ( ) : array => [
                ...
                Route::get('/{id}/restore'             ,   'ActivityController@restore'             )->name('restore'),
        ...
        //Package
            Route::name('package.')->prefix('/package')->group( fn ( ) : array => [
                ...
                Route::get('/{id}/restore'             ,   'PackageController@restore'             )->name('restore'),
        ...
        //PlayTime
            Route::name('play-time.')->prefix('/play-time')->group( fn ( ) : array => [
                ...
                Route::get('/{id}/restore'             ,   'PlayTimeController@restore'             )->name('restore'),
        ...
        //Quiz
            Route::name('quiz.')->prefix('/quiz')->group( fn ( ) : array => [
                ...
                Route::get('/{id}/restore'             ,   'QuizController@restore'             )->name('restore'),
        ...
        //Sub_user_lesson
            Route::name('sub-user-lesson.')->prefix('/sub-user-lesson')->group( fn ( ) : array => [
                ...
                Route::get('/{id}/restore'             ,   'SubUserLessonController@restore'             )->name('restore'),
        ...
        //Sub_user_quiz
            Route::name('sub-user-quiz.')->prefix('/sub-user-quiz')->group( fn ( ) : array => [
                ...
                Route::get('/{id}/restore'             ,   'SubUserQuizController@restore'             )->name('restore'),
        ...
        //Sub_user
            Route::name('sub-user.')->prefix('/sub-user')->group( fn ( ) : array => [
                ...
                Route::get('/{id}/restore'             ,   'SubUserController@restore'             )->name('restore'),
        ...
        //Subject
            Route::name('subject.')->prefix('/subject')->group( fn ( ) : array => [
                ...
                Route::get('/{id}/restore'             ,   'SubjectController@restore'             )->name('restore'),
        ...
        //Sub-subject
            Route::name('sub-subject.')->prefix('/sub-subject')->group( fn ( ) : array => [
                ...
                Route::get('/{id}/restore'             ,   'SubSubjectController@restore'             )->name('restore'),
        ...
        //True_false_question
            Route::name('true-false-question.')->prefix('/true-false-question')->group( fn ( ) : array => [
                ...
                Route::get('/{id}/restore'             ,   'TrueFalseQuestionController@restore'             )->name('restore'),
        ...
        // User_package
            Route::name('user-package.')->prefix('/user-package')->group( fn ( ) : array => [
                ...
                Route::get('/{id}/restore'             ,   'UserPackageController@restore'             )->name('restore'),
        ...
        Route::name('sounds.')->prefix('/sounds')->group( fn ( ) : array => [
            ...
            Route::get('/{id}/restore'             ,   'SoundsController@restore'             )->name('restore'),
        ...
        Route::name('soundable.')->prefix('/soundable')->group( fn ( ) : array => [
            ...
            Route::get('/{id}/restore'             ,   'SoundableController@restore'             )->name('restore'),
        ...
        Route::name('skin.')->prefix('/skin')->group( fn ( ) : array => [
            ...
            Route::get('/{id}/restore'             ,   'SkinController@restore'             )->name('restore'),
        ...
        Route::name('accessory-type.')->prefix('/accessory-type')->group( fn ( ) : array => [
            ...
            Route::get('/{id}/restore'             ,   'AccessoryTypeController@restore'             )->name('restore'),
        ...
        Route::name('accessory-part.')->prefix('/accessory-part')->group( fn ( ) : array => [
            ...
            Route::get('/{id}/restore'             ,   'AccessoryPartController@restore'             )->name('restore'),
        ...
        Route::name('body-suit.')->prefix('/body-suit')->group( fn ( ) : array => [
            ...
            Route::get('/{id}/restore'             ,   'BodySuitController@restore'             )->name('restore'),
        ...
        Route::name('human-part.')->prefix('/human-part')->group( fn ( ) : array => [
            ...
            Route::get('/{id}/restore'             ,   'HumanPartController@restore'             )->name('restore'),
