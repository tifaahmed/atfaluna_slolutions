...
//AgeGroupController
// Requests
use App\Http\Requests\Api\MatchQuestion\MatchQuestionApiRequest as modelInsertRequest;
...
class MatchQuestionController extends Controller
{
    ...
    public function __construct(ModelInterface $Repository,ModelInterfaceLanguage $RepositoryLanguage)
    {
        ...
        $this->folder_name = 'match-question/'.Str::random(10).time();
        $this->related_language = 'match_question_id';
    }
    public function all(){
        try {
    ...
    // lang update
        ...
        public function updateLanguage($model,$language_array ) {
            // get all row of language table
                $language_models  =  $model->match_question_languages()->get() ;
