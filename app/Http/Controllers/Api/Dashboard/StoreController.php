...
// Requests
use App\Http\Requests\Api\Store\StoreApiRequest as modelInsertRequest;
use App\Http\Requests\Api\Store\StoreUpdateApiRequest as modelUpdateRequest;

// Resources
use App\Http\Resources\Dashboard\Collections\StoreCollection as ModelCollection;
use App\Http\Resources\Dashboard\StoreResource as ModelResource;

// lInterfaces
use App\Repository\StoreRepositoryInterface as ModelInterface;
use App\Repository\StoreLanguageRepositoryInterface as ModelInterfaceLanguage; //Languages
        ...
        // lang update
            ...
            public function updateLanguage($model,$language_array ) {
                // get all row of language table
                    $language_models  =  $model->store_languages()->get() ;
